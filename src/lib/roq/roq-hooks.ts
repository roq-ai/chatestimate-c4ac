...
export function useAnalysisFindMany<
...
>(
  ...
  const key = JSON.stringify(['useAnalysisFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.analysis.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useAnalysisCount<T extends Prisma.analysisCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.analysisCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useAnalysisCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.analysis.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useAnalysisFindManyWithCount<
  T extends Prisma.analysisFindManyArgs,
  R extends { data: GetFindResult<Prisma.$analysisPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.analysisFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useAnalysisFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.analysis.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useAnalysisFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useAnalysisFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.analysis.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useChatFindMany<
  T extends Prisma.chatFindManyArgs,
  R extends GetFindResult<Prisma.$chatPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.chatFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useChatFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.chat.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useChatCount<T extends Prisma.chatCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.chatCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useChatCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.chat.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useChatFindManyWithCount<
  T extends Prisma.chatFindManyArgs,
  R extends { data: GetFindResult<Prisma.$chatPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.chatFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useChatFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.chat.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useChatFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useChatFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.chat.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePdfFileFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePdfFileFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.pdf_file.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePdfFileCount<T extends Prisma.pdf_fileCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.pdf_fileCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['usePdfFileCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.pdf_file.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePdfFileFindManyWithCount<
  T extends Prisma.pdf_fileFindManyArgs,
  R extends { data: GetFindResult<Prisma.$pdf_filePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.pdf_fileFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePdfFileFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.pdf_file.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePdfFileFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePdfFileFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.pdf_file.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
