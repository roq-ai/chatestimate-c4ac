...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ChatEstimate`}</title>

        <meta
          name="description"
          content="ChatEstimate - Transforming your PDF files into interactive conversational agents. Upload, chat, ask questions, and get instant analysis. Elevate your data understanding with a simple conversation."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1553484771-371a605b060b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwZGZ8ZW58MHx8fHwxNjk5OTQzMjI4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`ChatEstimate - Transforming your PDF files into interactive conversational agents. Upload, chat, ask questions, and get instant analysis. Elevate your data understanding with a simple conversation.`}
            </Text>
            <Box
